...
const T=[{"i": "\ud83d\udcf7", "l": "Camera Value", "d": "Vintage camera valuations", "h": "/value"}, {"i": "\ud83d\udccb", "l": "Collection", "d": "Track your gear", "h": "/collection"}, {"i": "\ud83d\udd0d", "l": "Identifier", "d": "Identify cameras", "h": "/identify"}, {"i": "\u270d\ufe0f", "l": "Listing Writer", "d": "eBay descriptions", "h": "/listing"}];
export default function P() {
  ...
  return (<div style={{minHeight:"100vh",background:"#040912",color:"#e2e8f0",fontFamily:"system-ui"}}>
    ...
    <section style={{background:"linear-gradient(135deg,#1E3A5F,#040912)",padding:"48px 24px 40px",textAlign:"center"}}>
      <h1 style={{fontSize:"clamp(22px,4vw,42px)",fontWeight:900,color:"#fff",margin:"0 0 10px",lineHeight:1.05}}>Camera Cache<br/><span style={{color:"#00B4D8"}}>Collection Hub</span></h1>
    ...
    <section style={{maxWidth:700,margin:"0 auto",padding:"24px 20px 0"}}>
      <div style={{background:"#0F1F32",border:"1px solid rgba(0,180,216,0.12)",borderRadius:14,padding:"18px 22px"}}>
        <div style={{display:"flex",gap:8}}><input value={i} onChange={e=>setI(e.target.value)} onKeyDown={e=>e.key==="Enter"&&go()} placeholder="Value this camera: 1959 Leica M3 chrome with 50mm Summicron" style={{flex:1,background:"#172D48",border:"1px solid rgba(0,180,216,0.15)",borderRadius:8,padding:"10px 12px",color:"#e2e8f0",fontSize:13,outline:"none",fontFamily:"system-ui"}}/>
